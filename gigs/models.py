...
class Task(models.Model):
    ...
    unit_price = models.DecimalField(max_digits=10, decimal_places=2, min_value=0.00, max_value=9999999999)
    total_participants = models.PositiveIntegerField(default=1)
    cost = models.DecimalField(max_digits=10, decimal_places=2, min_value=0.00, max_value=9999999999)
