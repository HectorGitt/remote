...
urlpatterns = [
    ...
    path('task/<slug:slug>/add_participants/', views.AddParticipants.as_view(), name='add_participants'),
    path('task/<slug:slug>/get_price/', views.getPrice.as_view(), name='get_price'),
    ...
    path('approve_transaction/<int:id>/', views.approve_payment_transaction, name='approve_transaction'),
    path('reject_transaction/<int:id>/', views.reject_payment_transaction, name='reject_transaction'),
    ...
    path('pay/verify_transaction/<uuid:reference>/', views.verify_payment_transaction, name='verify_transaction'),
